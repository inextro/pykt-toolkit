...
if __name__ == "__main__":
    ...
    parser.add_argument("-d","--dataset_name", type=str, default="ml-1m")
    parser.add_argument("-f","--file_path", type=str, default="../data/ml-1m/ratings.csv")
    parser.add_argument("-m","--min_seq_len", type=int, default=3)
    parser.add_argument("-l","--maxlen", type=int, default=100)
    ...
    dname, writef = data_proprocess.process_raw_data(args.dataset_name, dname2paths)
    print("-"*50)
